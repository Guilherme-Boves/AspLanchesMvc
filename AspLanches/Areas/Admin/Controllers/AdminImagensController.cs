...
namespace AspLanches.Areas.Admin.Controllers
{
    ...
    public class AdminImagensController : Controller
    {
        ...
        public async Task<IActionResult> UploadFiles(List<IFormFile> files)
        {
            ...
            // Juntando o diretório da pasta wwwroot com o diretório da pasta onde os arquivos serão armazenados.
            // Exemplo - wwwroot/images/produtos
            ...
            ViewData["Resultado"] = $"{files.Count} arquivo(s) foram enviados ao servidor, " + $"com o tamanho de: {size} bytes";
        ...
        {
            // Juntando o Nome do arquivo com o caminho onde ele está localizado
            string _deletaImagem = Path.Combine(_hostingEnvironment.WebRootPath, _myConfig.NomePastaImagensProdutos + "\\", fname);

            if (System.IO.File.Exists(_deletaImagem))
            {
                System.IO.File.Delete(_deletaImagem);

                ViewData["Deletado"] = $"Arquivo(s) {_deletaImagem} deletado com sucesso";
            }
